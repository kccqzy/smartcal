...
(deftest optimize-event
  ...
  (is (= (c/optimize-event (c/merge-event (day-rec 10 100 200)
         ...
         (reduce c/merge-event
           [(day-rec 10 100 111) (day-rec 5 120 196) (day-rec 10 205 236)]))
  ...
  (is (= (c/optimize-event (c/merge-event (week-rec 1 #{1} 701)
         ...
         (week-rec 1 #{1 2} 702))
      "combine dow")
  (is (= (c/optimize-event (c/merge-event (week-rec 1 #{1 2} 701)
                                          (week-rec 1 #{2} 701)))
         (week-rec 1 #{1 2} 702))
      "combine dow with strict subset")
  (is (= (c/optimize-event (c/merge-event (week-rec 1 #{1 2} 701)
                                          (week-rec 1 #{2} 708)))
         (week-rec 1 #{1 2} 702))
      "combine dow with strict subset and different start")
  (is (= (c/optimize-event (c/merge-event (week-rec 1 #{1} 701 1401)
                                          (week-rec 1 #{2} 701 2101)))
         (c/merge-event (week-rec 1 #{1 2} 702 1397)
                        (week-rec 1 #{2} 1403 2097)))
      "combine dow on overlapping periods")
  (is (= (c/optimize-event (week-rec 1 #{1 6} 699 1403))
         (reduce c/merge-event
           [(week-rec 1 #{6} 700 701) (week-rec 1 #{1 6} 702 1401)
            (week-rec 1 #{1} 1402 1403)]))
  ...
  (is (= (c/optimize-event (c/merge-event (week-rec 2 #{1 2 3} 701)
         ...
         (week-rec 2 #{1 2 3} 702))
      "a divisor is a multiple of another with same start")
  (is (= (c/optimize-event (c/merge-event (week-rec 2 #{1 2 3} 701)
                                          (week-rec 4 #{1 3 2} (+ 701 14))))
         (week-rec 2 #{1 2 3} 702))
      "a divisor is a multiple of another with later start")
  (is (= (c/optimize-event (c/merge-event (week-rec 2 #{1 2 3} 701)
                                          (week-rec 4 #{3 2} 701)))
         (week-rec 2 #{1 2 3} 702))
      "a divisor is a multiple of another with same start; dow subset")
  (is (= (c/optimize-event (c/merge-event (week-rec 2 #{1 2 3} 701)
                                          (week-rec 4 #{1 3} (+ 701 14))))
         (week-rec 2 #{1 2 3} 702))
      "a divisor is a multiple of another with later start; dow subset")
  (is (= (c/optimize-event (reduce c/merge-event
  ...
  (is (= (c/optimize-event (c/merge-event (week-rec 1 #{1 2 3} 708)
                                          (week-rec 1 #{3} 701)))
         (week-rec 1 #{1 2 3} 704))
      "absorb single day into week rec")
  (is (= (c/optimize-event (c/merge-event (week-rec 1 #{1 2 3} 708)
                                          (week-rec 1 #{2 3} 701)))
         (week-rec 1 #{1 2 3} 703))
      "absorb two days into week rec")
  (is (= (c/optimize-event (c/merge-event (week-rec 1 #{1 2 3} 708)
                                          (week-rec 6 #{2 3} 701)))
         (week-rec 1 #{1 2 3} 703))
      "absorb two days with different freq into week rec"))
